...
from Models.InsModelVA import InsModelVA
...
FA_ACCT_ITER_FILE = "test_va_model.csv"


class TestInsModelVA(unittest.TestCase):
    def setUp(self):
        pass
Ting
    def test_simple_va(self):
        df = self.run_va_model()
